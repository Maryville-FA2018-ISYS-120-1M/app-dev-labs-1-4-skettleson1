...
case 121...140:
    print("You are in the Light zone. Activity in this zone helps improve aerobic fitness.")
case 141...160:
    print("You are in the Moderate zone. Activity in this zone increases maximum performace capacity for shorter sessions.")
case 161...180:

...
var steps = 900
let stepGoal = 10000
if steps <= 5000 {print("You're almost halfway there!")}
else if steps <= 5000 {print("You're over halfway there!")}
/*:
 ...
 */
if steps <= (stepGoal * 1/10) {print("Way to get a good start today!")}
else if steps <= (stepGoal * 1/2 ) {print("You're almost halfway there!")}
else if steps >= (stepGoal * 1/2 ) {print("You're over halfway there!")}

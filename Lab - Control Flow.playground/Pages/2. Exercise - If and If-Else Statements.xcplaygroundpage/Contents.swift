 ...
 */
var dollars = 0
let sorryKid = "Sorry, kid. You're broke!"
if dollars == 0 {
    print(sorryKid)
}
 ...
 */
dollars = 10
let spendingMoney = "You've got some spending money!"
if dollars == 0 {
    print(sorryKid)
} else {print(spendingMoney)
}
/*:
 ...
 */
dollars = 105
if dollars == 0 {print(sorryKid)}
else if dollars <= 100 {print(spendingMoney)}
